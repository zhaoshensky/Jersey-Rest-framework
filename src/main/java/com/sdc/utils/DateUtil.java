...
public class DateUtil {
  ...
  //年月日 返回字符串类型
     ...
     */
    public static List<String> dateCount(String begin_time,String end_time){
...
//    	Date startDate = string2Date("2017-05-17");
//    	Date endDate = string2Date("2017-05-17");
//    	List<Date> dateList = getBetweenDates(startDate, endDate);
//    	for(int i =0; i < dateList.size(); i++){
//			String d = DateUtil.date2str(dateList.get(i),"yyyy-MM-dd");
