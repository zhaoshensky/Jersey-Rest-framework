...
public class JavaSmsApi {
    ...
    //apikey
    private static String API_KEY = "136e26863b7621a5361d9179e8585e53";
    //点开签名
    private static String DIANKAI_SIGN = "【点开微商城】";
    //SINGLE_SEND_URL单条发送消息
    private static String SINGLE_SEND_URL = "https://sms.yunpian.com/v2/sms/single_send.json";
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        //修改为您要发送的手机号
        String mobile = URLEncoder.encode("13137123703", ENCODING);
        String text = "【点开微商城】";
       // String s = singleSend(apikey, text, mobile);
       // System.out.println(s);
        /**************** 查账户信息调用示例 *****************/
        System.out.println(JavaSmsApi.getUserInfo(API_KEY));
    ...
    public static String singleSend(String text, String mobile) {
        ...
        params.put("text", DIANKAI_SIGN+text);
        try {
            params.put("mobile", URLEncoder.encode(mobile, ENCODING));
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
        return post(SINGLE_SEND_URL, params);//请自行使用post方式请求,可使用Apache HttpClient
    }
