...
* @Company: ediankai
*/
public class LoggerQueueListener implements MessageListener{

	private static final Logger logger = Logger.getLogger(LoggerQueueListener.class);
	@Autowired
