...
@Repository
public class RedisFeiheCrmPool implements RedisPool{  
	
	 private static final Logger logger = Logger.getLogger(RedisFeiheCrmPool.class);
	...
	public void setRedisPoolMaxTotal(int redisPoolMaxTotal) {
		RedisFeiheCrmPool.redisPoolMaxTotal = redisPoolMaxTotal;
	}
	...
	public void setRedisPoolMaxIdle(int redisPoolMaxIdle) {
		RedisFeiheCrmPool.redisPoolMaxIdle = redisPoolMaxIdle;
	}
	...
	public void setRedisPoolMaxWaitMillis(int redisPoolMaxWaitMillis) {
		RedisFeiheCrmPool.redisPoolMaxWaitMillis = redisPoolMaxWaitMillis;
	}
	...
	public  void setRedisPoolTestOnReturn(boolean redisPoolTestOnReturn) {
		RedisFeiheCrmPool.redisPoolTestOnReturn = redisPoolTestOnReturn;
	}

	/**
	 * @param redisPoolHostName the redisPoolHostName to set
	 */
     @Value("${redisfeihecrm.pool.hostName}")
	public void setRedisPoolHostName(String redisPoolHostName) {
		RedisFeiheCrmPool.redisPoolHostName = redisPoolHostName;
	}

	/**
	 * @param redisPoolPort the redisPoolPort to set
	 */
     @Value("${redisfeihecrm.pool.port}")
	public void setRedisPoolPort(int redisPoolPort) {
		RedisFeiheCrmPool.redisPoolPort = redisPoolPort;
	}
	...
	public void setRedisPoolTimeout(int redisPoolTimeout) {
		RedisFeiheCrmPool.redisPoolTimeout = redisPoolTimeout;
	}
