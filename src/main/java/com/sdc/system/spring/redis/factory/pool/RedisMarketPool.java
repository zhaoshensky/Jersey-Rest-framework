...
@Repository
public class RedisMarketPool implements RedisPool{  
	
	 private static final Logger logger = Logger.getLogger(RedisMarketPool.class);
	...
	public void setRedisPoolMaxTotal(int redisPoolMaxTotal) {
		RedisMarketPool.redisPoolMaxTotal = redisPoolMaxTotal;
	}
	...
	public void setRedisPoolMaxIdle(int redisPoolMaxIdle) {
		RedisMarketPool.redisPoolMaxIdle = redisPoolMaxIdle;
	}
	...
	public void setRedisPoolMaxWaitMillis(int redisPoolMaxWaitMillis) {
		RedisMarketPool.redisPoolMaxWaitMillis = redisPoolMaxWaitMillis;
	}
	...
	public  void setRedisPoolTestOnReturn(boolean redisPoolTestOnReturn) {
		RedisMarketPool.redisPoolTestOnReturn = redisPoolTestOnReturn;
	}

	/**
	 * @param redisPoolHostName the redisPoolHostName to set
	 */
     @Value("${redismarket.pool.hostName}")
	public void setRedisPoolHostName(String redisPoolHostName) {
		RedisMarketPool.redisPoolHostName = redisPoolHostName;
	}

	/**
	 * @param redisPoolPort the redisPoolPort to set
	 */
     @Value("${redismarket.pool.port}")
	public void setRedisPoolPort(int redisPoolPort) {
		RedisMarketPool.redisPoolPort = redisPoolPort;
	}
	...
	public void setRedisPoolTimeout(int redisPoolTimeout) {
		RedisMarketPool.redisPoolTimeout = redisPoolTimeout;
	}
