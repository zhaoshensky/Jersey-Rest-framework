...
@Repository
public class RedisDataPool implements RedisPool{  
	
	 private static final Logger logger = Logger.getLogger(RedisDataPool.class);
	...
	public void setRedisPoolMaxTotal(int redisPoolMaxTotal) {
		RedisDataPool.redisPoolMaxTotal = redisPoolMaxTotal;
	}
	...
	public void setRedisPoolMaxIdle(int redisPoolMaxIdle) {
		RedisDataPool.redisPoolMaxIdle = redisPoolMaxIdle;
	}
	...
	public void setRedisPoolMaxWaitMillis(int redisPoolMaxWaitMillis) {
		RedisDataPool.redisPoolMaxWaitMillis = redisPoolMaxWaitMillis;
	}
	...
	public  void setRedisPoolTestOnReturn(boolean redisPoolTestOnReturn) {
		RedisDataPool.redisPoolTestOnReturn = redisPoolTestOnReturn;
	}

	/**
	 * @param redisPoolHostName the redisPoolHostName to set
	 */
     @Value("${redisdata.pool.hostName}")
	public void setRedisPoolHostName(String redisPoolHostName) {
		RedisDataPool.redisPoolHostName = redisPoolHostName;
	}

	/**
	 * @param redisPoolPort the redisPoolPort to set
	 */
     @Value("${redisdata.pool.port}")
	public void setRedisPoolPort(int redisPoolPort) {
		RedisDataPool.redisPoolPort = redisPoolPort;
	}
	...
	public void setRedisPoolTimeout(int redisPoolTimeout) {
		RedisDataPool.redisPoolTimeout = redisPoolTimeout;
	}
